...
Head over to [getting started](/content/getting-started#install-kubectl) if you need help setting up Kubectl.
...
Some resource get recreated when deleted, if you want to remove an app, use the [/delete](/content/deploy/naisd.md#delete-endpoint) endpoint instead.
