...
The application should emit `json`-formatted logs by writing directly to standard output. This will make it easier to index, view and search the logs later. See more details in the [logs documentation](https://github.com/nais/doc/tree/8c67c55b42d6da64d90f83effa058ac58e70d79c/content/logs/README.md)
