...
Prometheus is used to scrape metrics from the pod. You have to add Prometheus in your [NAIS manifest](https://github.com/nais/doc/tree/20ee3f1398feb07583257d04cffacfb336b0ec9a/documentation/contracts/README.md#nais-manifest) to enable scrape.
