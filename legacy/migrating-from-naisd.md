...
The new format looks like this. Check out [in depth](in-depth/nais-manifest) for a more complete list.
...
* [ ] [Install and configure kubectl](basics/access)
* [ ] [Create an Azure AD group](basics/teams) for your team, for human access to the cluster

## 3. Deploying applications

See the [Deploy your application](basics/deploy) section.
