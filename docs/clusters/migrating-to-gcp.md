...
| domain: dev.intern.nav.no | ✔️ \(IAC\) | ✔️ \(Automatic\) | Wildcard DNS points to GCP load balancer |
| Access to FSS services (if migrating from SBS) | ✔️ | ✔️ | Identical \(either API-GW or [TokenX](../security/auth/tokenx.md). |
