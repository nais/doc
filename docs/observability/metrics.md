...
If you need data stored longer then what Prometheus support, we recommend using [BigQuery](/persistence/bigquery) or your own [Aiven Influxdb](/persistence/influxdb).
