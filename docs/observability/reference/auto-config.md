...
| -------- | ---------------------- | ------------ |
| `java`   | [2.31.1][java-agent]   | 1.62.0       |
| `nodejs` | [0.78.0][nodejs-agent] | 0.219.0      |
| `python` | [0.63b1][python-agent] | 1.42.1       |
| `dotnet` | [1.16.0][dotnet-agent] |              |

[java-agent]: https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/tag/v2.31.1
...
[dotnet-agent]: https://github.com/open-telemetry/opentelemetry-dotnet-instrumentation/releases/tag/v1.16.0
