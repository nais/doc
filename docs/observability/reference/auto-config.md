...
| -------- | ---------------------- | ------------ |
| `java`   | [2.25.0][java-agent]   | 1.55.0       |
| `nodejs` | [0.70.1][nodejs-agent] | 0.208.0      |
| `python` | [0.51b0][python-agent] | 1.30.0       |
| `dotnet` | 1.12.0                 |              |

[java-agent]: https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/tag/v2.25.0
[nodejs-agent]: https://github.com/open-telemetry/opentelemetry-js-contrib/releases/tag/auto-instrumentations-node-v0.70.1
