...
| -------- | ---------------------- | ------------ |
| `java`   | [2.27.0][java-agent]   | 1.55.0       |
| `nodejs` | [0.73.0][nodejs-agent] | 0.208.0      |
...
[nodejs-agent]: https://github.com/open-telemetry/opentelemetry-js-contrib/releases/tag/auto-instrumentations-node-v0.73.0
