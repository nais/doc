...
| -------- | ---------------------- | ------------ |
| `java`   | [2.27.0][java-agent]   | 1.62.0       |
| `nodejs` | [0.71.0][nodejs-agent] | 0.219.0      |
| `python` | [0.51b0][python-agent] | 1.42.1       |
| `dotnet` | [1.15.0][dotnet-agent] |              |

[java-agent]: https://github.com/open-telemetry/opentelemetry-java-instrumentation/releases/tag/v2.27.0
