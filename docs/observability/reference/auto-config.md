...
| `nodejs` | [0.71.0][nodejs-agent] | 0.208.0      |
...
[nodejs-agent]: https://github.com/open-telemetry/opentelemetry-js-contrib/releases/tag/auto-instrumentations-node-v0.71.0
