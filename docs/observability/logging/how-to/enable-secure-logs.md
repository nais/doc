...
If your team has never before produced secure logs, give a warning in [#kibana](https://nav-it.slack.com/archives/C7T8QHXD3) Slack channel for the admins to open access for your team. Remember to include the name of your Nais team in the message.
