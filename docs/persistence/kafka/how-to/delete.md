...
``` bash
kubectl annotate topic <TOPIC> --namespace=<MY-TEAM> --context=<MY-ENV> kafka.nais.io/removeDataWhenResourceIsDeleted=true
```
...
```bash
kubectl delete topic <TOPIC> --namespace=<MY-TEAM> --context=<MY-ENV>
```
