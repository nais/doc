...
The value in [`retention`](../reference/topic-spec.md#configretentionbytes) is the total retention, where [`localRetention`](../reference/topic-spec.md#configlocalretentionbytes) describes what is minimally in local storage.
