...
Google's documentation has a list of possible [predefined roles](https://cloud.google.com/iam/docs/understanding-roles#predefined_roles) that we at NAIS recommend teams keep in mind/use.
