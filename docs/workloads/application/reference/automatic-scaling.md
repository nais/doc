...
!!! warning
    ...
    In order to use custom scaling policies and rules, make sure you disable default Nais HPA by setting the [`.spec.replicas.disableAutoScaling`](spec.md#replicasdisableautoscaling) field to `true`. 
