...
The team needs to update their ROS and PVK analysis to migrate to GCP. Refer to [Google Cloud Platform](gcp.md)'s [ROS and PVK section](../legal/).
...
The same deployment mechanism is leveraged for both on-premise and GCP K8s clusters. See [deployment](../deployment/) section of the documentation for how to leverage the _NAIS deploy tool_.
...
A PVK is not a unique requirement for GCP, so all applications should already have one. See [about security and privacy when using platform services](https://doc.nais.io/#about-security-and-privacy-when-using-platform-services) for details
...
See [laws and regulations](https://github.com/nais/doc/tree/932e9f768c79fa093819ad9b9afa8731431cd78f/clusters/..legal/README.md) for details.
