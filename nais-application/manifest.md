...
Prometheus is used to scrape [metrics\]\(](https://github.com/nais/doc/tree/79527f39474e7c6a356dd3a06f95250db2ba0f5c/observability/metrics/README.md) from the pod.
...
Putting this information in a secret is safer and more flexible than putting it verbatim in a Pod definition or in a container image. See [GCP only features/secrets]() for more information.
...
Default will not allow any traffic to or from application. [Access policy]() is currently supported in GKE clusters, only.
