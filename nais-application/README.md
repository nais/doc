---
description: >-
  More detailed information about some of the features of the NAIS manifest,
  also called NAIS spec, or nais.yaml
---
...
The application should emit `json`-formatted logs by writing directly to standard output. This will make it easier to index, view and search the logs later. See more details in the [logs documentation](https://github.com/nais/doc/tree/5d1a8d8f05ea1da04ac269bc0dd64441908248ad/nais-application/observability/logs/README.md).
