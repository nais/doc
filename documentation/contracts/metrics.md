...
Prometheus is used to scrape metrics from the pod. You have to add Prometheus in your [NAIS manifest](/doc/contracts/README.md#nais-manifest) to enable scrape.
